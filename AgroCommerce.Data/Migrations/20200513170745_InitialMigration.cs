        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email_ = table.Column<string>(nullable: true),
                    Gender_ = table.Column<int>(nullable: false),
                    ZipCode = table.Column<string>(nullable: true),
                    role = table.Column<string>(nullable: true),
                    IsBasicProfileDetailsSet = table.Column<bool>(nullable: false),
                    IsAccountComplete = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocalGovtArea = table.Column<string>(nullable: true),
                    City = table.Column<string>(nullable: true),
                    IsClustered = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationMgt", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeWeek = table.Column<int>(nullable: true),
                    AgeConvertedToWeeks = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Review_Transaction_TransactionId",
